  ...
  return (
    <>
      {cartitems?.length > 0 ? (
          ...
          <section class="py-10 bg-gray-100 font-poppins dark:bg-gray-700">
            <div class="px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
              <div >
                ...
                }  class="text-gray-800  font-semibold  border-2 border-solid dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300  rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                  clear cart
                </button>
                </div>
                    ...
                    <div class="p-6 border border-blue-100 dark:bg-gray-900 dark:border-gray-900 bg-gray-50 md:p-8">
                      ...
                      <div class="flex items-center justify-center mt-6">
                        <p>
                          ...
                          <button class="pl-1 text-blue-600 hover:underline dark:text-gray-300">
                            Continue Shopping
                          </button>
                        </p>
                      </div>
        ...
        <div className="flex justify-center items-center h-96 w-full flex-col">
